  ...
  return (
    <div className="home__text_block">
        ...
        <div className='img-phone'>
            <img className='img-phone-1' src='phone'></img>
            <img className='img-dialog-1' src='dialog-1'></img>
            <img className='img-dialog-2' src='dialog-2'></img>
            <img className='img-pic' src='pic'></img>
            <img className='img-circle-bg' src='circles-bg'></img>
        </div>
    </div>
  )
}
